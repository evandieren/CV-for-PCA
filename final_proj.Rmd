...
* Check Methods again
* Run simulation study on synthesized data (- Emphasize on noise, correlation, hyperparameter r, comparing with elbow plots) - document along the way
...
* Report:
  ...
  * Extend [1.3 Simulation dataset description]
  ...
  * Read through other parts and note down suggestions and **any** uncerteinty
  * Ask Masàk next week
