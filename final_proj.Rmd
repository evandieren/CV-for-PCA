...
* Questions:
  ...
  * Q or l_comp for convergence
  * C is sigma from previous loop?
...
This approach is a modfication of the KDE  method. We want to minimize over the rank $R$ this formula $\mathbb{E} \| \widehat{C}_R - C \|_2^2 = \mathbb{E}\| \widehat{C}_R \| - 2 \mathbb{E} \langle \widehat{C}_R, C \rangle + \| C \|_2^2$ with $\widehat{C}_R$ being the the truncated estimator having rank $R$.
...
$$
Therefore, since the truncated coveriance estimator isn't linear we obtain an approximation. Based on this strategy we'll choose the rank $R$ to minimize our CV.
