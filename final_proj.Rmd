...
<ol>
<li> Which extend do we have to explain the theory? (PCA itself and 4 methods for CV) -> Kinda introduction to CV on PCA, like to read yourself in order to get familiar, meaningful plots, refer to further informations when just scratching them, explain PCA mehtods and differences</li>
...
<li>Non-automated methods : scree-plot (the elbow plot)

<li>Lallallero</li>
<li>Yuppijayjay schweineback
<li> Eliott smell like pigs
