...
* Check Method0 - WrongPCA again <span style="color:orange">Noah</span>
* Check Method1 - WrongPCAImproved again <span style="color:orange">Noah</span>
* Check Method2 - MissingData again <span style="color:gray">Eliott</span>
* Check Method3 - KDEApproach again <span style="color:orange">Noah</span>
* Check Method4 - MatrixCompletion <span style="color:orange">Noah</span>
...
* Rerun simulation study on real data set - document along the way <span style="color:orange">Noah</span>, <span style="color:gray">Eliott</span>
* Report:
  
  * For **each** method explanation, pseudo-code, simulation & documentation, conclusion <span style="color:orange">Noah</span>, <span style="color:gray">Eliott</span>
  * Extend [1.3 Simulation dataset description] <span style="color:brown">Emanuele</span>
  * Add a section 1.4 for the real data set and what we want to examine  <span style="color:brown">Emanuele</span>
  * I think adding a paragraph add the and combining all the methods for the real data set at the would be the cleanest way and a nice tranisition for the overall conclusion afterwards
  * Overall conclusion
