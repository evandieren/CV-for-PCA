...
lol : Imaging sliding down slide with no end, gravity would make that an endless ride, the same concept is happening here but due to computational constraints, the endlessness is adapted to finite.
