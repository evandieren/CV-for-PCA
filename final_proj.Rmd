...
* Find a multivariate Gaussian Data set
...
* Check Method2 - MissingData again
...
* Rerun simulation study on real data set - document along the way
* Report:
  
  * For **each** method explanation, pseudo-code, simulation & documentation, conclusion
  * Extend [1.3 Simulation dataset description] <span style="color:orange">Noah</span>
  * Add a section 1.4 for the real data set and what we want to examine
  * I think adding a paragraph add the and combining all the methods for the real data set would be the cleanest way
  * Overall conclusion
